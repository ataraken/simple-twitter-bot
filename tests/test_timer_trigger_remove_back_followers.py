...
class TestTimerTriggerRemoveBackFollowers(unittest.TestCase):
    ...
    @patch('shared_code.twitter.api.v1.proxy.request')
    @patch('shared_code.twitter.api.v1.friendships_destroy.Param')
    @patch('shared_code.twitter.api.v1.followers_ids.Param')
    @patch('shared_code.twitter.api.v1.friends_ids.Param')
