...
class TestTimerTriggerRemoveBackFollowers(unittest.TestCase):
    ...
    def init_mocks(self, friends_mock, followers_mock, destroy_mock,
        ...
        post_session_mock.return_value = Mock()
    ...
    def test1(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test2(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test3(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test_error1(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test_error2(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test_error3(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
    ...
    @patch('shared_code.twitter_followers_ids_helper.Param')
    @patch('shared_code.twitter_friends_ids_helper.Param')
    def test_error4(self, friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock):
        self.init_mocks(friends_mock, followers_mock, destroy_mock,
                    get_session_mock, post_session_mock, request_mock)
